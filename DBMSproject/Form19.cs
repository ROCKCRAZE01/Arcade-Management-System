...
namespace DBMSproject
{
    public partial class Form19 : Form
    {
        ...
        private void Form19_Load(object sender, EventArgs e)
        {
            ...
            cmd.CommandText = "select * from scores where machine_no = 3 AND username = '" + Form4.s + "'";
            cmd.CommandType = CommandType.Text;
            OracleDataAdapter da = new OracleDataAdapter(cmd.CommandText, conn);
            DataSet ds = new DataSet();
            da.Fill(ds, "scores");
            dataGridView1.DataSource = ds.Tables[0];
            cmd.CommandText = "SELECT COUNT(*) from scores where machine_no = 3 AND username = (select username from player where username = '" + Form4.s + "')";
